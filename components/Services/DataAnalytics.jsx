    ...
    <section className="py-16 bg-white">
      <div className="text-center mb-12 px-4">
        <motion.h2
          ...
          viewport={{ once: true }}
        >
          Fuel Your Business Growth with Data & Analytics
        </motion.h2>
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Explore our detailed blogs to discover data trends, strategies, and
          step-by-step roadmaps to make smarter decisions and automate processes
