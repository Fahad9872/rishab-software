...
const ERBanner3 = ({ Close }) => {
  ...
  return (
    <div className="relative h-screen md:h-auto bg-[#F5F5F5] md:bg-white shadow-lg px-5 pt-12 sm:px-4 md:px-8 rounded-lg md:rounded-xl overflow-hidden w-screen md:w-[80vw] mx-auto z-50">
      {/* Close Button */}
      <button
        onClick={Close}
