      ...
      <div className="relative py-20 px-5 text-center overflow-hidden rounded-b-[60px]">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-semibold mb-6">
            Your search for the best IT jobs in Vadodara, Gujarat, and India
            ends here. It's time to take your career to new heights with us.
            Learn more about our culture and life at Rishabh.
          </h2>
